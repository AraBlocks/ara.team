...
<a href="#cookies">Cookie Info</a>, and
<a href="#sms">SMS and MMS Terms and Conditions</a>.</p>
<h1 id="terms">1. Terms and conditions</h1>
<p>Ara Foundation ("Ara Foundation", "Ara", "we" or "us") provides the content on this Web site (the "site") subject to the following Terms and Conditions ("terms").
...
For an explanation of Ara Foundation's practices and policies related to the collection, use, and storage of our users' information, please read our <a href="#privacy">Privacy notice</a>.</p>
<h2>1.1. Site content and use</h2>
<p>All content and functionality on the site, including text, graphics, logos, icons, and images and the selection and arrangement thereof ("site content"), is the exclusive property of Ara Foundation, its affiliates or its licensors and is protected by US and international copyright laws.
The trademarks, service marks, designs, and logos (collectively, the "trademarks") displayed on the site are the registered and unregistered trademarks of Ara Foundation, its affiliates and its licensors.
...
You may not reproduce, modify, distribute, transmit, post, or disclose the site content without Ara Foundation's prior written consent.</p>
<p>You agree that you will not refer to or attribute any site content to Ara Foundation or its affiliates or licensors in any public medium (e.g., press release, social media post, app notification, websites) for advertising or promotion purposes or for the purpose of informing or influencing any third party, and that you will not use or reproduce any trademark of, or imply any endorsement by or relationship with, Ara Foundation or its affiliates or licensors.</p>
...
<p>Ara Foundation prohibits the posting of any content that infringes or violates the copyright rights and/or other intellectual property rights (including rights of privacy and publicity) of any person or entity.
If you believe that your intellectual property right (or such a right that you are responsible for enforcing) is infringed by any content on the site, please write to Ara Foundation at the address shown below, giving a written statement that contains: (a) identification of the copyrighted work and/or intellectual property right claimed to have been infringed; (b) identification of the allegedly infringing material on the site that is requested to be removed; (c) your name, address, and daytime telephone number, and an e-mail address if available; (d) a statement that you have a good faith belief that the use of the copyrighted work and/or exercise of the intellectual property right is not authorized by the owner, its agent, or the law; (e) a statement that the information in the notification is accurate, and, under penalty of perjury, that the signatory is authorized to act on behalf of the owner of the right that is allegedly infringed; and (f) the signature of the intellectual property right owner or someone authorized on the owner's behalf to assert infringement of the right.
Ara Foundation will remove any posted content that infringes the copyright or other intellectual property right of any person under US law upon receipt of such a statement (or any statement in conformance with 17 USC § 512(c)(3)).</p>
<h2>1.3. Disclaimers</h2>
<p>THE CONTENT AND FUNCTIONALITY ON THE SITE IS PROVIDED WITH THE UNDERSTANDING THAT ARA FOUNDATION IS NOT HEREIN ENGAGED IN RENDERING PROFESSIONAL ADVICE AND SERVICES TO YOU.
...
ARA FOUNDATION AND ITS THIRD-PARTY CONTENT PROVIDERS MAKE NO WARRANTIES, EXPRESS OR IMPLIED, AS TO THE OWNERSHIP, ACCURACY, OR ADEQUACY OF THE SITE CONTENT.
ARA FOUNDATION SHALL HAVE NO LIABILITY OR RESPONSIBILITY FOR ANY INFORMATION PUBLISHED ON LINKED WEB SITES, CONTAINED IN ANY CONTENT PUBLISHED ON THE SITE, OR PROVIDED BY THIRD PARTIES.
NEITHER ARA FOUNDATION NOR ITS THIRD-PARTY CONTENT PROVIDERS SHALL BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES OR FOR LOST REVENUES OR PROFITS, WHETHER OR NOT ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR LOSSES AND REGARDLESS OF THE THEORY OF LIABILITY.</p>
...
<p>You agree that these terms and any claim, dispute or controversy (whether in contract, tort or otherwise, whether preexisting, present or future, and including statutory, common law and equitable claims) between you and Ara Foundation arising from or relating to these terms, its application, interpretation or breach, termination or validity, the site, or any related transaction, shall, to the maximum extent permitted by applicable law, be governed by the laws of the state of Wyoming, without regard to its conflicts of laws rules.
You agree that all claims you may have arising from or relating to the operation, use or other exploitation of the site will be heard and resolved in the federal and state courts located in the State of Wyoming.
...
<p>Ara Foundation ("Ara Foundation", "Ara", "we", "us", or "our") is an interactive agency providing web development, media planning and buying, technology and innovation, emerging media, analytics, mobile, advertising, creative, social influence marketing, and search services to our clients.
...
When data is collected on this site, Ara Foundation is acting as a data controller.</p>
...
<p>Please email <em><a href="mailto:staff@ara.team">staff@ara.team</a></em> if you want to make use of any of your below-mentioned legal rights.</p>
...
Simply either (a) reply STOP to a SMS text message you receive from us; (b) click on the link in the footer of the email communications you receive from us; or (c) send us an email at <em><a href="mailto:staff@ara.team">staff@ara.team</a></em> with the word <em>unsubscribe</em> in the subject field of the email.</p>
...
<p>US residents may exercise their applicable privacy rights by sending an email to <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.</p>
...
To submit your appeal, contact <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.</p>
...
If you are a Nevada consumer and wish to submit a request relating to our compliance with Nevada law, please contact us at <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.</p>
...
<p>To opt out of us using your data for <em>Matched Ads</em>, please contact us at <em><a href="mailto:staff@ara.team">staff@ara.team</a></em> and specify that you wish to opt out of matched ads.
...
<p>You can opt-out of receiving promotional emails from us at any time by following the instructions as provided in emails to click on the unsubscribe link, or by emailing us at <em><a href="mailto:staff@ara.team">staff@ara.team</a></em> with the word <em>Unsubscribe</em> in the subject field of the email.
...
If you are a parent or guardian and believe we have collected personal data in violation of COPPA, contact us at <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.
...
If you think that the site or any personal data is not secure or that there has been unauthorized access to the site or your personal data, please contact <em><a href="mailto:staff@ara.team">staff@ara.team</a></em> immediately.</p>
...
Should you wish to know more about how your personal data is protected or wish to request a copy of the contractual protections please contact <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.</p>
...
<p>Ara Foundation has a user page or a company page on social media platforms like X (previously Twitter), Facebook, Instagram, YouTube, and LinkedIn that you can use or visit.
Ara Foundation acts as a joint data controller with the social media platform for the collection of your personal data when you visit our company page on the social media platform.
...
Ara Foundation is joint data controllers with the social media platforms for the collection of your personal data that is collected by the platforms when you visit our site.</p>
...
If you experience any difficulties accessing the information here, please contact us at <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.</p>
<p>If you consider that we are not complying with this privacy notice, if you have any questions in relation to this privacy notice, or have questions about your rights and choices, please contact <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.
Data subjects in Europe may also lodge a formal complaint with their competent data protection authority.</p>
<p>If you have any questions about our data practices or you wish to exercise your rights or know about the contractual protections in place, please contact <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.</p>
<h1 id="cookies">3. Cookie info</h1>
<h2>3.1. Cookie notice</h2>
<p>This Ara Foundation website ("site") is edited and hosted by Ara Foundation ("Ara Foundation", "Ara", "we", "us", "our"), whose registered office is located at 2425 Canyon Blvd., Ste. 110, Boulder, CO 80302.</p>
<p>Ara Foundation is regarded as a co-controller of cookies placed on this site under applicable data protection laws.</p>
<p>The purpose of this notice is to inform you about the collection and use of cookies when browsing our site.
For further information about this notice please contact <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.</p>
...
If you have questions about the services provided by our use of SMS, email us at <em><a href="mailto:staff@ara.team">staff@ara.team</a></em>.</p>
<p><strong>Privacy.</strong>
If you have any questions regarding privacy, read our <a href="#privacy">Privacy notice</a>.</p>

<p class="text-gray-100">
The forty numerals below are used only for spacing:
